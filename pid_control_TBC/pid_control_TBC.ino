...
// Sampling interval value - sets the sampling frequency within the PID control loop
const int Ts = 100;

//Derivative value to be determined after tuning the proportional constant
//unsigned float kd = 100 * kp;
...
void loop()
{
  ...
  switch (integralCountN) {
    case 0:
      intCount0 = error;
      integral = intCount0;
      break;
    case 1:
      intCount1 = error + intCount0;  
      integral = intCount1; 
      break;   
    case 2:
      intCount2 = error + intCount1;
      integral = intCount2;
      break;
    case 3:
      intCount3 = error + intCount2;
      integral = intCount3;
      break;
    case 4:
      intCount4 = error + intCount3;
      integral = intCount4;
      break;
    case 5:
      intCount5 = error + intCount4;
      integral = intCount5;
      break;
    case 6:
      intCount6 = error + intCount5;
      integral = intCount6;
      break;
    case 7:
      intCount7 = error + intCount6;
      integral = intCount7;
      break;
    case 8:
      intCount8 = error + intCount7;
      integral = intCount8;
      break;
    case 9:
      intCount9 = error + intCount8;
      integral = intCount9;
      integralCountN = -1;
      break;
    default:
  ...
  // improve performance.
  //int power_difference = (kp * error) + (ki * integral) + (kd * derivative) - (ksr * srError);
  int power_difference = (kp * error) + (ki * integral) + (kd * derivative);
  //int power_difference = (kp * error) + (kd * derivative);
  //int power_difference = (kp * error) + (ki * integral);
  //int power_difference = (kp * error);
  ...
  if (power_difference < 0)
    OrangutanMotors::setSpeeds(maxSpeed + power_difference, maxSpeed);
  else
    OrangutanMotors::setSpeeds(maxSpeed, maxSpeed - power_difference);
